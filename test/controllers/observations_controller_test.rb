...
class ObservationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create observation" do
    assert_difference('Observation.count') do
      post observations_url, params: { observation: { defect: @observation.defect, description: @observation.description, name: @observation.name, response_id: @observation.response_id } }
    end
  ...
  test "should update observation" do
    patch observation_url(@observation), params: { observation: { defect: @observation.defect, description: @observation.description, name: @observation.name, response_id: @observation.response_id } }
